...
**Tous les endpoints requièrent une authentification Bearer Token JWT.**
...
### 7. Générer le code d'intégration (iframe)
...
// 2. Générer le code d'intégration
const embedResponse = await fetch(
    `/api/forms/${formId}/embed?width=100%&height=600`,
    {
        headers: {
            Authorization: "Bearer " + token,
        },
