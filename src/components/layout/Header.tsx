          ...
          <div className="flex items-center space-x-2">
            ...
            <div className="relative">
              <input
                ...
                className="w-40 pl-10 pr-4 py-2 text-sm bg-surface-800 border border-surface-700/50 rounded-xl text-text-100 placeholder-surface-400 focus:outline-none focus:ring-2 focus:ring-yellow-500/50 focus:border-yellow-500/50 transition-all duration-200"
              />
