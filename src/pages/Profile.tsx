            ...
            <div className="space-y-4">
              <div>
                ...
                <p className="text-base text-surface-400 mb-4">
                  ...
                  votre compte utilisateur, toutes vos informations
                  personnelles, vos formulaires créés, les soumissions reçues,
                  votre historique d'activité, vos préférences, ainsi que votre
                  abonnement et vos données de facturation.
                </p>
                {!showDeleteConfirm ? (
                  <Button
                    variant="accent"
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="flex gap-3">
                      <Button variant="accent" onClick={handleDeleteAccount}>
                        <Trash2 className="h-4 w-4 mr-2" />
                        Oui, supprimer
                      </Button>
                      <Button
