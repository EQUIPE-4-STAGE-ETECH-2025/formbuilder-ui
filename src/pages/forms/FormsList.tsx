    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          ...
          <p className="text-gray-600">Gérez vos formulaires et suivez leurs performances</p>
        </div>
        <Link to="/forms/new">
          <Button>
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex-1">
                      ...
                      <div className="flex items-center gap-6 text-sm text-gray-500">
                        <span>{form.submissionCount} soumissions</span>
                        <span>Modifié {formatDistanceToNow(new Date(form.updatedAt), { addSuffix: true, locale: fr })}</span>
